...
Decimos que fumar causa cáncer, que la causa de muerte fue un paro cardiaco, que el fuego causó el incendio de el inmueble, etc.
...
El segundo día nosotros caemos enfermos, los síntomas son los mismos, pero además tenemos diarrea.
...
Pero añadir nueva información hace que nos retractemos de esta conclusión.
Supongamos que el día anterior fuimos a comer tacos, donde la carne era de dudosa procedencia, por lo que ahora parece que la enfermedad no fue causada por nuestro familiar, sino por la carne que ingerimos el día anterior.
Dada esta nueva información, parece que la causa de nuestra enfermedad tiene un origen diferente e ingerir los mismos medicamentos puede llevarnos a agravar nuestros síntomas.
...
Si fallamos en dar con la causa de nuestra enfermedad, las consecuencias podrían ser terribles, es por ello el análisis de las causas es de suma importancia.
Sin embargo, el ejemplo anterior falla en ilustrar la complejidad involucrada en nuestra búsqueda de relaciones causales.
Para ilustrar dicha complejidad pensemos, por ejemplo, en las diferentes relaciones que hay entre el genotipo y el fenotipo.[^1]
Con el proyecto del genoma humano, los investigadores lograron secuenciar completamente el ADN de un grupo de seres humanos.
La secuenciación del ADN consiste en determinar el orden exacto de los *nucleótidos* (adenina, guanina, citocina y tiamina) que constituyen los segmentos del ADN.
Una secuencia de tres de estos 4 nucleótidos constituye un *codón* que codifica para una proteína.
Sin embargo, una proteína puede estar determinada por más de un codón, además, hay tres codones que regulan dicha proteína, es decir detienen la producción de dicha proteína.
...
Sabemos además que la selección natural actúa cuando un grupo dentro de una población de organismos tiene alguno de estos rasgos, de tal manera que les ofrece la oportunidad de sobrevivir más y dejar más descendencia.
Este rasgo tiene que ser heredable, donde la unidad de herencia es el gen.

Ahora bien, es plausible pensar que una región de ADN, esto es un gen, determina exactamente una proteína y, por tanto, un rasgo específico del organismo.
Pero la interacción entre diferentes genes hace compolicado que podamos hacer esto. 
Fenómenos como la *pleiotropia*, la *epístasis* y el *desequilibro de enlace* complican llegar a una conclusión de este tipo.
...
Estas interacciones entre diferentes partes del código genético hacen complicada la tarea de buscar patrones causales.
Sin embargo, los biólogos han diseñado diferentes maneras de experimentar cuando hay una relación causal entre el genotipo (el conjunto de genes) y el fenotipo (los rasgos que podemos ver en los organismos).
Como un ejemplo de esto, unos investigadores querían descubrir cómo la luz y la temperatura, por separado, afectan el proceso de floración en plantas del género *Arabidopsis*. 

En el artículo [@ausin2005], los autores desarrollan un modelo experimental para saber cuál es la relación entre la floración del género y cómo afectan la temperatura y la luz.
...
Por lo que es de esperarse que tanto aquellas características del organismo relacionadas a la temperatura, también estén relacionadas con la luz.

Los investigadores señalan que se desconocen muchos de los procesos moleculares involucrados en la floración.
Sin embargo, en el género *Arabidopsis* se han estudiado los aspectos genéticos del fenómeno de la floración.
Además se descubrió que los genes que regular la floración bajo diferentes temperaturas y longitudes de onda de la luz, son independientes.
Lo que significa que distintos genes están involucrados: unos ayudan a acelerar la floración en bajas temperaturas, mientras otros aceleran la floración a diferentes longitudes de onda.

Para el experimento se sometió a los especímenes a temperaturas bajas (aunque no al punto de congelamiento) y observaron cómo el proceso de floración se acelera en consecuencia. 
...
Sin duda, como seres humanos, tenemos muchas intuiciones acerca de la causalidad, tanto que en principio, no parece interesante preguntarse acerca de su naturaleza
Sin embargo, espero que estos ejemplos sirvan como motivación para comenzar a preguntarse no sólo sobre la naturaleza de la *causalidad*, sino también acerca de la *justificación* de relaciones causales.
Este segundo aspecto está relacionado con la explicación científica, que es uno de los temas de estudio de la filosofía de la ciencia.

Para este capítulo el plan es el siguiente.
Comenzaré repasando lo que algunos filósofos han dicho acerca de la naturaleza de la causalidad, es decir, la *metafísica* de la causalidad.
Luego señalaré las virtudes y problemas de dichas teorías.
Como segunda parte, entrarñé en detalles sobre la explicación científica.
Por lo regular asumimos que la investigación científica está dedicada a dar explicaciones causales de los fenómenos.
Este debate está enmarcado en aspectos *epistémicos* de las relaciones causales, en particular, en cómo justificamos que existe una relación causale entre fenómenos.
...
Comenzando por Aristóteles, el estagirita concibe a las causas como una respuesta a una pregunta, en particular señala que los físicos deben estar al tanto de las causas.
Aristóteles dice "Es evidente que hay causas y que son tantas como hemos indicado, pues tantos son los modos en que podemos entender el 'por qué' de las entes."[^2] [-@aristoteles2008{p. 158}].

¿Cuáles son las causas que hemos indicado? En la física [@aristoteles2008{pp. 140-146}, Especialmente], distingue 4 maneras en las que se dice que algo es una "causa".
...
La segunda forma que distingue Aristóteles es que la causa es la forma del objeto, es decir, lo que hace que un objeto sea lo que es y no otra.
El hecho de que la lámpara sea tal y no un pedestal o perchero.
En tercer lugar, decimos que la causa es aquello que produce el movimiento o el reposo.
Por ejemplo, que la pelota se movión por la patada y se detuvo por chocar con la portería.
Por último decimos que es causa el fin (o el bien) para lo cuál está diseñado (en el caso de los instrumentos) o el find e una actividad.
Decimos que la salud se debe al ejercicio: la finalidad del ejericio es la buena salud.

Estas cuatro maneras, caracterizadas por Aristóteles, en las que decimos que algo causa algo, interactúan de diferentes formas.
Supongamos que queremos explicar por qué hay una estatua en nuestra comunidad.
...
Por último podemos apelar a la función de la estatua. 
Señalar, por ejemplo que la persona representada era muy querida por la comunidad y esto ayuda a la comunidad a prosperar.
Cabe aclarar que Aristóteles no dice que las 4 causas deben estar presentes para ofrecer una explicación, sino que, alo más, son 4 las formas en que algo causa su efecto.
...
Esto parece ser lo que Hume tiene en mente cuando argumenta que nuestro entendimiento de la relación causa-efecto: que los hechos están conectados de alguna manera.
Esto no va a ser una reconstrucción cronológica completa, sino una brevísima hiistoria, por lo que pasaré ahora a los argumentos de Hume.

## Hume

En la sección anterior ofrecí una presentación de las 4 causas aristótelicas.
La forma más estándar de usar "causa" es aquella en la que hay una conexión entre dos entes.
...
Las cuatro causas aristotélicas son caracterizadas como formas en las que podemos ofrecer una explicación, justificar por qué el vidrio está roto.
Por su parte, Hume presenta un desafío: esta misma relación de conexión no está justificada.

Para llegar a esta conclusión, Hume señala que todo el conocimiento humanos proviene de dos fuentes: *relaciones de ideas* y *cuestiones de hecho*.
Las relaciones de ideas incñuyen aquellas investigaciones abstractas como las de la geometría: la verdad de las afirmaciones de la geometría pueden descubrirse sólo pensando, sin necesidad de recurrir a nuestras impresiones sensoriales. 
...
No tenemos bases para afirmar que es verdadero, porque podemos pensar y concebir lo contratrio en cualquier cuestión de hecho.
...
Sin embargo, esto no significa que la investigación empírica es fútil, sino que la evidencia nunca es suficiente para probar (demostrar) nuestro conocimiento de cuestiones de hecho, dependen de la evidencia y la comprobación.
Pero como seres humanos, tenemos cierta expectativa de los eventos, esperamos que haya una relación general entre la causa y el efecto.
Es la única forma en la que somos capaces de extrapolar eventos del pasado y tener expectativa de eeventos futuros.
La manera en que razonamos en cuestiones de hehco depende de la relación de causa y efecto, a su vez, dicha conexión depende --nos dice Hume-- de de la asociación constante de objetos; uno siguiendo a otro.

Entonces, dicha conexión, es a su vez una cuestión de hecho: depende de nuestra experiencia.
Pensemos en los efectos de cualquier evento $x$.
Sabemos que los efectos son diferentes a las causas, si nos preguntaran cuáles serán los efectos de $x$ sin conslutar nuestra experiencia pasada.
En este caso, sólo podemos responder arbitrariamente, por mas posibilidades que imaginemos, hay una infinidad de ellas que podrían ser el caso: no hay forma de que dicha relación no dependa de nuestra experiencia.
Si esto es verdad, entonces no hay manera de probar (en sentido estricto), que dicha relación es completamente infalible.

Para finalizar esta sección, me gustarñia remarcar un par de cuestiones.
...
Por su parte, Hume nos presenta con un problema sobre la misma justificación de la conexión entre causa y efecto.
Digamos que Hume se dedica a analizar la naturaleza de dicha conexión.

En el trabajo citado, Hume no dice que esta conexión sea injustificable, sino que no podemos ofrecer una demostración (un argumento epistémico).
Pero nuestro razonamiento de cuestiones de hecho depende de la relación de causa y efecto.
Luego, Hume se dedica a decirnos en qué consiste dicha relación.
No está explícitamente en la presentación anterior, pero Hume señala que lo único a lo que podemos apelar en este caso es a nuestra costumbre.

Vemos entes que detonan otras entes y, mientras más entes de un tipo pasando después de entes de otro tipo, nuestro razonamiento es más seguro: aunque nunca demostrado.
Hume responde a su propio desafío diciéndonos que sólo la conjunción constante y la costumbre son los constituyentes de las relaciones causales.

Esta respuesta no está libre de problemas.
Supongamos que hago el siguiente experimento: aplaudo durante 4 días seguidos justo antes del anochecer.
¿Es suficiente mi costumbre y la conjunción constante de mi aplaudir y el anochecer, para decir que están causalmente relacionados?
La respuesta obvia es no.
Los accidentes ocurren constantemente y no podemos concluir que hay una relación causal en este caso. 

Además, Hume también señala que la relación causal tiene una dirección: las causas preceden a los efectos.
Algunos filósofos han argumentado que no tiene sentido decir que la causalidad tiene dicha popiedad.
Bertrand Russell, por ejemplo, señala que las disciplinas científicas (como la física), no se basan en causalidad [@russell1912].[^5]

La investigación científica no está dedicada a descripciones de objetos particulares, sino que pretende generalizar.
Pero la causalidad no depende de que a la misma causa, siempre siga el mismo efecto.
Esto nos lleva al análisis de la naturaleza de la causalidad, que es de lo qeu se ocupa la siguiente sección.
